...
- **引擎规范文件路径**：E:\claudeCode\DOC\GODOT-RULES.md（例：/Users/me/skills/UNITY-RULES.md）
- **视觉规范文件路径**：GODOT-VISUAL-DEV_RULES.md（例：/Users/me/skills/UNITY-VISUAL-RULES.md，没有就写"无"）
...
- **目标工程路径**：E:\claudeCode\goDOT\FWTCG_GODOT_V6（移植后的新项目路径，例：E:\Projects\NewGame）
...
- **目标引擎/框架**：Godot 4.6.1（Unity / Godot / Unreal / Web）
