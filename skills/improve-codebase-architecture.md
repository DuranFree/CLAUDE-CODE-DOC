...
- **Dependency category**: See the [Dependency Categories](#dependency-categories) section below for the four categories
...
4. Dependency strategy (how deps are handled — see the [Dependency Categories](#dependency-categories) section below)
5. Trade-offs
...
Create a refactor RFC as a GitHub issue using `gh issue create`. Use the template provided in the [Issue Template](#issue-template) section below. Do NOT ask the user to review before creating — just create it and share the URL.
