# Port / Migration — Phase 5: 架构优化

移植全部完成、游戏能跑起来后才进入此阶段。

## 何时使用

- Ported code is working but messy
- Hard to add new features on top of the port
- Tests are hard to write for certain systems
...
- Where do tightly-coupled modules create risk?
...
- **True external**: third-party services — mock at the boundary only
